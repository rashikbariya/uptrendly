                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover ">
                                    ...
                                    <tr>
                                        <td class="w-10">
                                            <img src="{{url('frontend/img')}}/c3.png" alt="">
                                        </td>
                                        <td>
                                            <h6>DevMarketer</h6>
                                            <small class="text-muted">Paresh Daia</small>
                                        </td>
                                        <td>2</td>
                                       <td><span class="icon icon-circle s-12  mr-2 text-success"></span> Active </td>
                                        <td>
                                            <span><i class="icon icon-data_usage"></i> 4 of 5 Days left</span><br>
                                            <span><i class="icon icon-timer"></i> Per day 3000</span>
                                        </td>
                                        <td>
                                            <a class="btn-fab btn-fab-sm btn-primary shadow text-white"><i class="icon-pencil"></i></a>
                                             <a class="btn-fab btn-fab-sm btn-danger shadow text-white"><i class="icon-trash"></i></a>
                                        </td>
                                    </tr>

                                     <tr>
                                        <td class="w-10">
                                            <img src="{{url('frontend/img')}}/c1.png" alt="">
                                        </td>
                                        <td>
                                            <h6>Mo Vlogs</h6>
                                            <small class="text-muted">Mohan Vai</small>
                                        </td>
                                        <td>1</td>
                                     ...
                                     <tr>
                                        <td class="w-10">
                                            <img src="{{url('frontend/img')}}/c2.png" alt="">
                                        </td>
                                        <td>
                                            <h6>MSK vlogs</h6>
                                            <small class="text-muted">Mohammed Salim Khan</small>
                                        </td>
                                        <td>1</td>
                                        <td><span class="icon icon-circle s-12  mr-2 text-warning"></span> Inactive </td>
                                         <td>
                                              <span><i class="icon icon-data_usage"></i> For 3 day(s)</span><br>
                                            <span><i class="icon icon-timer"></i> Per day 4000</span>
                                         </td>
                                        <td>
                                            <a class="btn-fab btn-fab-sm btn-primary shadow text-white"><i class="icon-pencil"></i></a>
                                              <a class="btn-fab btn-fab-sm btn-danger shadow text-white"><i class="icon-trash"></i></a>
