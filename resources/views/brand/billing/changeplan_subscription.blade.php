                ...
                <div class="card clearfix" style="padding: 10px" >
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-custom">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('brand/billing/plans')}}">Billing Plans</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><span>Change to {{$pricingData->pricing_title}} plan</span></li>
                        </ol>
                    </nav>
                           ...
                           <div class="card pricing-card-body border-primary">
                               <div class="text-center pricing-card-head">
                                   ...
                                   <div class="plan-price">
                                       Nrs {{$pricingData->price_per_month}}
